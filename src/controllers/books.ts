...
import { getBookByUserId, createBook, deleteBook, getBookById, getBooks, getBooksOrderCategory, getBooksOrderGenre, getBooksOrderTime, updateBookById, updateBookCoverById, updateBookPdfUrlById } from "../service/books";
...
export class booksController {
    @Post()
    async create(@Body() body: { title: string, description: string, pdf_url: string, id_user: string, category: string, genre: string }){
