...
const replies_1 = require("../service/replies");
let repliesController = class repliesController {
    async signup(body) {
        return (0, replies_1.createReply)(body);
    }
    async signin(id) {
        return (0, replies_1.getRepliesByReviewId)(id);
    }
    async update(id, body) {
        return (0, replies_1.updateReplyById)(id, body);
    }
    async delete(id) {
        return (0, replies_1.deleteReply)(id);
    }
};
...
], repliesController.prototype, "signup", null);
__decorate([
    (0, common_1.Get)('/:id'),
    ...
    __metadata("design:returntype", Promise)
], repliesController.prototype, "signin", null);
__decorate([
    (0, common_1.Patch)('/:id'),
    __param(0, (0, common_1.Param)('id')),
