...
const authors_1 = require("../service/authors");
let authorsController = class authorsController {
    async create(body) {
        return (0, authors_1.createAuthor)(body);
    }
    async get() {
        return (0, authors_1.getAuthors)();
    }
    async retrieve(id) {
        return (0, authors_1.getAuthorById)(id);
    }
    async update(id, body) {
        return (0, authors_1.updateAuthorById)(id, body);
    }
};
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], authorsController.prototype, "get", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], authorsController.prototype, "retrieve", null);
__decorate([
    (0, common_1.Patch)('/:id'),
    __param(0, (0, common_1.Param)('id')),
