...
const playlists_1 = require("../service/playlists");
let playlistsController = class playlistsController {
    async create(body) {
        return (0, playlists_1.createPlaylist)(body);
    }
    async retrieve(id) {
        return (0, playlists_1.getPlaylistsById)(id);
    }
    async update(id, body) {
        return (0, playlists_1.updatePlaylistById)(id, body);
    }
    async delete(id) {
        return (0, playlists_1.deletePlaylist)(id);
    }
};
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], playlistsController.prototype, "retrieve", null);
__decorate([
    (0, common_1.Patch)('/:id'),
    __param(0, (0, common_1.Param)('id')),
